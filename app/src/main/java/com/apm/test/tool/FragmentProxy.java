...
public class FragmentProxy {
    ...
    public static void callonCreate(Fragment fromfragment) {
        if (!Config.activityColection)
            return;
        else {
            if (fromfragment == null) {
    ...
    public static void callonResume(Fragment fromfragment) {
        if (!Config.activityColection)
            return;
        else {
            if (APMFragMap.get(fromfragment.getClass().getName()) == true) {
    ...
    public static void callonPause(Fragment fromfragment) {
        if (!Config.activityColection)
            return;
        else
            APMFragMap.put(fromfragment.getClass().getName(), false);
